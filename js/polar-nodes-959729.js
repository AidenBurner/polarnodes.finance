/*!
 * lucidweb: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var lucidweb = lucidweb || [];
 *   lucidweb.push(readyFunction);
 */
...
var _ = lucidweb._ = __webpack_require__(131);
...
var lucidweb = __webpack_require__(4);
...
var lucidweb = __webpack_require__(4); // polyfill based off of https://github.com/matteobad/focus-within-polyfill
...
/* globals
  ...
  document,
  FormData,
  lucidweb_FORM_API_HOST,
  lucidweb_FORM_OLDIE_HOST
*/
...
lucidweb.define('forms', module.exports = function ($, _) {
  var api = {};
  var $doc = $(document);
  var $forms;
  var loc = window.location;
  ...
  function init() {
    ...
    formUrl = "https://lucidweb.com" + '/api/v1/form/' + siteId; // Work around same-protocol IE XDR limitation - without this IE9 and below forms won't submit

    if (retro && formUrl.indexOf("https://lucidweb.com") >= 0) {
      formUrl = formUrl.replace("https://lucidweb.com", "http://formdata.lucidweb.com");
    }
  ...
  function build(i, el) {
    ...
    if (action) {
      return;
    } // lucidweb forms for hosting accounts


    if (siteId) {
      data.handler = typeof hostedSubmitlucidweb === 'function' ? hostedSubmitlucidweb : exportedSubmitlucidweb;
      return;
    } // Alert for disconnected lucidweb forms
  ...
  function addListeners() {
    listening = true; // Handle form submission for lucidweb forms
  ...
  function exportedSubmitlucidweb(data) {
    preventDefault(data);
    afterSubmit(data);
